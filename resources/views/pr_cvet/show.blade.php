    ...
    <section class="product-card">
        <div class="product-card__items the-product" data-nid="59">
            ...
            <div class="product-card__item product-card__item_pc-buttons pc-buttons">
                ...
                <div class="pc-buttons__item pc-buttons__item_item2"><a class="button_light _icon-wa">Обсудить в WhatsApp</a></div>
    ...
    <section class="recomendations">
        <div class="rec-block">
            ...
            <div class="rec-block__nodes nodes">
                    ...
                    <div class="product-card__item product-card__item_gallery gallery nodes__img">
                        <div class="swiper-grid">
                            <div class="swiper swiper-rec ">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide"><img class="the-node-image" src="../../../img/recs/Shycloud-15-060820_1.jpg" alt=""></div>
                                    <div class="swiper-slide"><img class="the-node-image" src="../../../img/recs/Shycloud-02-060820.jpg" alt=""></div>
                ...
                <div class="nodes__item nodes__cell">
                    <div class="product-card__item product-card__item_gallery gallery nodes__img">
                        <div class="swiper-grid">
                            <div class="swiper swiper-rec ">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide"><img src="../../../img/recs/Shycloud-02-060820.jpg" alt=""></div>
                                    <div class="swiper-slide"><img src="../../../img/recs/Shycloud-15-060820_1.jpg" alt=""></div>
                                    <div class="swiper-slide"><img src="../../../img/recs/Shycloud-02-060820.jpg" alt=""></div>
                ...
                <div class="nodes__item nodes__cell">
                    <div class="product-card__item product-card__item_gallery gallery nodes__img"><img src="../../../img/recs/Shycloud-21-060820.jpg" alt=""></div>
                    <div class="product-card__item product-card__item_h1 nodes__label">07 Shycloud</div>
                    <div class="specs__item product-card__item product-card__item_spec price nodes__price">
                        €81 (м2)</div>
                    <div class="nodes__heart"><img class="add-to-cart" src="../../img/icons/Like.svg" alt="">
        ...
        <div class="rec-block">
            ...
            <div class="rec-block__nodes nodes">
                <div class="nodes__item nodes__cell">
                    <div class="product-card__item product-card__item_gallery gallery nodes__img"><img src="../../../img/recs/Shycloud-rakurs-01-060820 (1).jpg" alt="">
                    </div>
                    <div class="product-card__item product-card__item_h1 nodes__label">07 Shycloud</div>
                    <div class="specs__item product-card__item product-card__item_spec price nodes__price">
                        €81 (м2)</div>
                ...
                <div class="nodes__item nodes__cell">
                    <div class="product-card__item product-card__item_gallery gallery nodes__img"><img src="../../../img/recs/Shycloud-rakurs-02-060820.jpg" alt="">
                    </div>
                    <div class="product-card__item product-card__item_h1 nodes__label">07 Shycloud</div>
                    <div class="specs__item product-card__item product-card__item_spec price nodes__price">
                        €81 (м2)</div>
                ...
                <div class="nodes__item nodes__cell">
                    <div class="product-card__item product-card__item_gallery gallery nodes__img"><img src="../../../img/recs/Shycloud-rakurs-15-060820_1_1.jpg" alt="">
                    </div>
                    <div class="product-card__item product-card__item_h1 nodes__label">07 Shycloud</div>
                    <div class="specs__item product-card__item product-card__item_spec price nodes__price">
                        €81 (м2)</div>
                ...
                <div class="nodes__item nodes__cell">
                    <div class="product-card__item product-card__item_gallery gallery nodes__img"><img src="../../../img/recs/Shycloud-rakurs-21-060820.jpg" alt="">
                    </div>
                    <div class="product-card__item product-card__item_h1 nodes__label">07 Shycloud</div>
                    <div class="specs__item product-card__item product-card__item_spec price nodes__price">
                        €81 (м2)</div>
