        ...
        <form method="POST"  action="{{ route('pr_collections.update', $prCollection) }}" enctype="multipart/form-data">
            ...
            <div>
                ...
                <x-input 
                    ...
                    type="text" 
                    name="name" 
                    :value="old('name') ?? $prCollection->name" 
                    required 
                    autofocus
                />
            </div>
            ...
            <div>
                ...
                <x-input 
                    ...
                    type="text" 
                    name="nickname" 
                    :value="old('nickname') ?? $prCollection->nickname" 
                    autofocus 
                />
            </div>
            ...
            <div>
                ...
                <x-input 
                    ...
                    type="text" 
                    name="description" 
                    :value="old('description') ?? $prCollection->description" 
                    autofocus 
                />
            </div>
            <!-- Specs -->
            ...
            <div>
                ...
                <x-input 
                    ...
                    type="text" 
                    name="default_price" 
                    :value="old('default_price') ?? $prCollection->default_price" 
                    required 
                    autofocus
                />
            </div>
